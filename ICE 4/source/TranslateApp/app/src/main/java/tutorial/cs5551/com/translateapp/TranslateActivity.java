...
//        destSpinner.setAdapter(adapter);
    ...
    public void translateText(View v) {
        ...
        String inputLang = inputSpinner.getSelectedItem().toString();
        Spinner DestinationSpinner = (Spinner) findViewById(R.id.destSpinner);
        String outputLang = DestinationSpinner.getSelectedItem().toString();
        //to map key & values in array
        ...
        map.put("Spanish","es");
        map.put("English","en");
        outputLang = (String) map.get(outputLang);
        inputLang = (String) map.get(inputLang);
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang=" + inputLang + "-" + outputLang + "&[format=plain]&[options=1]&[callback=set]";//The API service URL
